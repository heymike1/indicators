...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for 243 Indicators - how we collect, use, and protect your information.",
};

export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="Aug 22, 2026">
      <p>
        ...
        (“Personal Information”) on the 243indicators.com website (“Website” or
      ...
      <p>
        ...
        “your”) and Funded Gallery (doing business as “243 Indicators”,
        ...
        you must not accept this Policy and may not access and use the Website
        and Services.
      </p>
      <p>
      ...
      <p>
        ...
        as this Policy. We suggest that you review their respective privacy
        policies.
      </p>
      ...
      <p>
        ...
        fulfilled, to enforce our Policy, resolve disputes, and unless a longer
      ...
      <p>
        ...
        Netherlands. The transfer of your Personal Information to countries
      ...
      <p>
        <strong>(i)</strong> You have the right to withdraw consent where you
        have previously given your consent to the processing of your Personal
        Information. To the extent that the legal basis for our processing of
      ...
      <p>
        <strong>(ii)</strong> You have the right to learn if your Personal
      ...
      <p>
        <strong>(iii)</strong> You have the right to verify the accuracy of your
        information and ask for it to be updated or corrected. You also have the
        right to request us to complete the Personal Information you believe is
        incomplete.
      </p>
      <p>
        <strong>(iv)</strong> You have the right to object to the processing of
        your information if the processing is carried out on a legal basis other
        than consent. Where Personal Information is processed for the public
        interest, in the exercise of an official authority vested in us, or for
        the purposes of the legitimate interests pursued by us, you may object
        to such processing by providing a ground related to your particular
        situation to justify the objection. You must know that, however, should
        your Personal Information be processed for direct marketing purposes,
        ...
        for direct marketing purposes, you may refer to the relevant sections of
        this Policy.
      </p>
      <p>
        <strong>(v)</strong> You have the right, under certain circumstances, to
        restrict the processing of your Personal Information. These
        circumstances include: the accuracy of your Personal Information is
        contested by you and we must verify its accuracy; the processing is
        unlawful, but you oppose the erasure of your Personal Information and
        request the restriction of its use instead; we no longer need your
        Personal Information for the purposes of processing, but you require it
        to establish, exercise or defend your legal claims; you have objected to
        processing pending the verification of whether our legitimate grounds
        override your legitimate grounds. Where processing has been restricted,
        such Personal Information will be marked accordingly and, with the
      ...
      <p>
        <strong>(vi)</strong> You have the right, under certain circumstances,
        ...
        processed; you withdraw consent to consent-based processing; you object
        ...
        a legal obligation; or for the establishment, to exercise or defense of
        legal claims.
      </p>
      <p>
        <strong>(vii)</strong> You have the right to receive your Personal
        Information that you have provided to us in a structured, commonly used,
        ...
        provided that such transmission does not adversely affect the rights and
        freedoms of others.
      </p>
      <p>
        <strong>(viii)</strong> You have the right to complain to a data
        protection authority about our collection and use of your Personal
        Information. If you are not satisfied with the outcome of your complaint
        directly with us, you have the right to lodge a complaint with your
        local data protection authority. For more information, please contact
        your local data protection authority in the EEA. This provision is
      ...
      <p>
        ...
        and across third-party websites. However, some third-party websites may
        keep track of your browsing activities when they serve you content,
        which enables them to tailor what they present to you. For a description
        of Do Not Track protocols for browsers and mobile devices or to learn
        more about the choices available to you, visit internetcookies.com
      </p>
      ...
      <p>
        We offer push notifications to which you may also voluntarily subscribe
        at any time. To make sure push notifications reach the correct devices,
        we use a third-party push notifications provider who relies on a device
      ...
      <p>
        ...
        you or if you wish to exercise your rights, you may mail us to submit
        your request.
      </p>
      <p>
      ...
      <p>
        <a href="mailto:info@243indicators.com">info@243indicators.com</a>
      </p>
      <p>
